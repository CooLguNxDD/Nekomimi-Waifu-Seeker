<!-- Implementation status: phases 0-4 of this plan are implemented on this branch.
The lexicon lives in waifu_engine/nekomimi/lexicon/. The sections below are the research plan and remain the schema. -->
