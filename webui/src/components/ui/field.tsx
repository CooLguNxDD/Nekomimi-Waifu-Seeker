...
const field =
  "rounded-[10px] border border-[#333] bg-[#1a1d24] px-3 py-2 text-inherit outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";
